...
INSERT INTO included.table_to_replicate (name, archived)
  VALUES ('test row 1.1', true),
  ('test row 1.2', false);

INSERT INTO included.table_to_replicate2 (name, archived)
  VALUES ('test row 2.1', true),
  ('test row 2.2', false);

INSERT INTO excluded.table_to_replicate3 (name, archived)
